...
class Config(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-backbone_model_path', default=None, type=str)
        parser.add_argument('-backbone_result_folder', default=None, type=str)
        parser.add_argument('-unary_prior_model_path', default=None, type=str)
        parser.add_argument('-temporal_prior_model_path', default=None, type=str)
        parser.add_argument('-bet_model_path', default=None, type=str)
        parser.add_argument('-temporal_order', default=None, type=str)
        parser.add_argument('-unary_prior_model_att_path', default=None, type=str)
        parser.add_argument('-result_folder_1', default=None, type=str)
        parser.add_argument('-result_folder_2', default=None, type=str)
