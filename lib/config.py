...
class Config(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-unary_model_path', default=None, type=str)
        parser.add_argument('-temporal_model_path', default=None, type=str)
        parser.add_argument('-weight_model_path', default=None, type=str)
