...
class STTran(nn.Module):
    ...
    def __init__(self, mode='sgdet',
                 attention_class_num=None, spatial_class_num=None, contact_class_num=None, attention_classes=None, spatial_classes=None, contacting_classes=None, obj_classes=None, rel_classes=None,
        ...
        self.spatial_classes = spatial_classes
        self.contacting_classes = contacting_classes
    ...
    def forward(self, entry):
        ...
        entry['rel_feat'] = rel_features
        
        gpu_device = rel_features.device
        entry["attention_distribution"] = torch.zeros([rel_features.shape[0], self.attention_class_num]).to(gpu_device)
        entry["spatial_distribution"] = torch.zeros([rel_features.shape[0], self.spatial_class_num]).to(gpu_device)
        entry["contacting_distribution"] = torch.zeros([rel_features.shape[0], self.contact_class_num]).to(gpu_device)
